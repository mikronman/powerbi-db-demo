...
-- Ensure SQLCMD mode is ON when running in SSMS/Azure Data Studio
...
BEGIN TRY
    ...
    COMMIT TRAN;
    PRINT 'Schema objects created, FKs added, indexes applied.';
END TRY
BEGIN CATCH
...
DECLARE @counts TABLE (TableName sysname, RowCount bigint);
